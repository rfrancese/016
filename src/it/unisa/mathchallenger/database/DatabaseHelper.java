...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		String query_amici="CREATE TABLE IF NOT EXISTS amici ("+
				"account INTEGER,"+
				"username_amico TEXT NOT NULL,"+
				"id_amico INTEGER"+
				")";
		db.execSQL(query_amici);
		
		String query_partite="CREATE TABLE IF NOT EXISTS partite ("+
				"id_partita INTEGER NOT NULL,"+
				"account INTEGER NOT NULL,"+
				"id_sfidante INTEGER NOT NULL,"+
				"username_sfidante TEXT NOT NULL,"+
				"stato_partita INTEGER"+
				")";
